...
const stats = [
  { value: company.founded, label: 'Год основания' },
  { value: company.employees, label: 'Специалистов' },
  { value: company.projects, label: 'Завершённых проектов' },
  { value: company.regions, label: 'Регионов Казахстана' },
];
...
export default function Hero() {
  return (
    ...
    >
      {/* Background gradient simulating forest/nature photo */}
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 flex items-end justify-center pb-4">
        <span className="text-white/20 text-xs italic">
          [Фото: горные леса Заилийского Алатау, Алматинская область, Казахстан]
        </span>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white pt-24 pb-16">
        ...
        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-8 text-sm font-medium">
          ...
          Научно-проектная организация в области экологии
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <a
            href="#services"
            className="inline-flex items-center gap-2 bg-white text-green-800 font-semibold px-8 py-4 rounded-xl hover:bg-green-50 transition-colors shadow-lg"
          >
            Наши услуги
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 bg-transparent border-2 border-white/50 text-white font-semibold px-8 py-4 rounded-xl hover:bg-white/10 hover:border-white transition-colors"
          >
            Связаться с нами
          </a>
        </div>
