      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Выборка показательных работ из нашего портфолио — от создания ООПТ до рекультивации
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((proj) => (
            <article
              key={proj.id}
              className="bg-white rounded-2xl border border-gray-100 hover:border-green-200 hover:shadow-xl transition-all overflow-hidden group"
            >
              {/* Image placeholder */}
              <div className="aspect-video bg-gradient-to-br from-green-800 to-teal-600 relative overflow-hidden">
                <div className="absolute inset-0 flex items-end p-3">
                  <p className="text-white/50 text-xs italic leading-tight">
              ...
              <div className="p-5">
                <h3 className="font-semibold text-gray-900 mb-3 leading-snug text-sm group-hover:text-green-700 transition-colors">
                  {proj.title}
                </h3>
                ...
                <div className="space-y-2 text-xs text-gray-400">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span className="leading-tight">{proj.client}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1.5 mt-4">
                  {proj.tags.map((tag) => (
                    <span
                      key={tag}
                      className="flex items-center gap-1 text-xs px-2 py-0.5 bg-gray-100 text-gray-500 rounded-full"
                    >
        ...
        <div className="text-center mt-10">
          <a
            href="#contact"
            className="inline-block border-2 border-green-700 text-green-700 font-semibold px-8 py-3 rounded-xl hover:bg-green-700 hover:text-white transition-colors"
          >
