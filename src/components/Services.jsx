import {
  Map, FlaskConical, Trees, Sprout, Flower2, Compass, Recycle, Globe,
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Полный спектр научно-проектных, экспертных и консультационных услуг в сфере
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className={`bg-white rounded-2xl p-6 border ${c.border} ${c.hover} hover:shadow-lg transition-all group cursor-default`}
              >
                {/* Number */}
                ...
                <h3 className="font-semibold text-gray-900 mb-3 leading-snug text-sm">
                  {service.title}
                </h3>
        ...
        <div className="mt-12 bg-green-800 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-green-200 mb-6 text-sm">
            Свяжитесь с нами — мы формируем индивидуальные решения для каждого клиента.
          </p>
          <a
            href="#contact"
            className="inline-block bg-white text-green-800 font-semibold px-6 py-3 rounded-xl hover:bg-green-50 transition-colors"
          >
            Обсудить задачу
          </a>
        </div>
